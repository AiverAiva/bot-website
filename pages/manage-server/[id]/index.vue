<template>
  <div class="min-h-screen bg-gray-900 text-white p-4">
    ...
    <div class="max-w-4xl mx-auto py-8" v-if="server">
      ...
      <div class="bg-gray-800 p-6 rounded-lg shadow-md mb-6">
        <h2 class="text-2xl font-semibold mb-4">Manage Modules</h2>
        <p>Click the button below to manage server modules.</p>
        <button @click="goToModules" class="mt-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-400 transition">
          Manage Modules
        </button>
      </div>
...
import Loader from '~/components/Loader.vue' // Import your Loader component if it's custom
...
const goToModules = () => {
  router.push(`/manage-server/${serverId}/modules`)
}
</script>
